const romajiMap: Record<string, string> = {
  // 3文字 (長音強化版)
  "tsu": "ツ", "kya": "キュウ", "kyu": "キュウ", "kyo": "キョウ", // kya -> キャ だが、kyu -> キュウ
  "sha": "シャ", "shu": "シュウ", "sho": "ショウ", "chi": "チ",
  "cha": "チャ", "chu": "チュウ", "cho": "チョウ", "nya": "ニャ",
  "nyu": "ニュウ", "nyo": "ニョウ", "hya": "ヒャ", "hyu": "ヒュウ",
  "hyo": "ヒョウ", "mya": "ミャ", "myu": "ミュウ", "myo": "ミョウ",
  "rya": "リャ", "ryu": "リュウ", "ryo": "リョウ", "gya": "ギャ",
  "gyu": "ギュウ", "gyo": "ギョウ", "ja": "ジャ", "ju": "ジュウ",
  "jo": "ジョウ", "jya": "ジャ", "jyu": "ジュウ", "jyo": "ジョウ",
  "bya": "ビャ", "byu": "ビュウ", "byo": "ビョウ", "pya": "ピャ",
  "pyu": "ピュウ", "pyo": "ピョウ", "dya": "ヂャ", "dyu": "ヂュウ",
  "dyo": "ヂョウ", "shi": "シ", "fa": "ファ", "fi": "フィ",
  "fe": "フェ", "fo": "フォ", "che": "チェ", "she": "シェ",
  "tse": "ツェ", "je": "ジェ",
  // 2文字
...
export const romajiToKatakana = (romaji: string): string => {
  ...
  while (i < str.length) {
    ...
    if (char === nextChar && char !== 'n' && 'bcdfghjklmpqrstvwxyz'.includes(char)) {
      result += 'ッ';
      i++;
      continue;
    }
    ...
    if (romajiMap[char]) {
      ...
      if (isLastChar && 'bcdfghjklmpqrstvwxyz'.includes(char) && char !== 'n' && char !== 'x') {
        // 末尾の不完全な子音は無視する
        break;
      }
